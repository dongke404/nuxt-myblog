...
export const isIndexRoute = name =>
  name === systemConstants.Route.Index

export const isArticleDetailRoute = name =>
  name === systemConstants.Route.ArticleDetail

export const isSearchArchiveRoute = name =>
  name === systemConstants.Route.SearchArchive

export const isGuestbookRoute = name=>
  name === systemConstants.Route.Guestbook

export const isServiceRoute = name =>
  name === systemConstants.Route.Service

export const isMusicRoute = name =>
