  ...
  <aside id="aside" class="aside">
    <div class="aside-search">
      <div class="search-box">
        ...
        <client-only>
          <datalist v-if="1" id="keywords" class="search-keywords">
            <option
              v-for="tag in tags"
              :key="tag.slug"
              class="iiem"
      ...
      <nuxt-link to="/" class="sitemap-btn">
    ...
    <div class="aside-article">
      ...
      <ul v-else class="aside-article-list">
        <li v-for="item in articles" :key="item.id" class="item">
          <span class="index" />
          <nuxt-link class="title" :to="`/`" :title="`${item.title} - 「  |  」`">
    ...
    <div class="aside-sticky-box">
      <div class="aside-tag">
        ...
        <ul v-else class="aside-tag-list">
          <nuxt-link v-for="(tag, index) in tags" :key="index" tag="li" class="item" :to="`/`">
...
export default Vue.extend({
  ...
  methods: {
    ...
    handleStickyStateChange(event) {
      ...
      const mainContentElementHeight = document.getElementById("main-content")
